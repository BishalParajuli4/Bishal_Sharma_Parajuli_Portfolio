      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {skills.map((skillGroup) => (
          <div
            ...
            className="bg-white/5 backdrop-blur-md dark:bg-gray-800 p-6 rounded-lg shadow-md transform hover:scale-105 transition-transform duration-300"
          >
    ...
    <div className="max-w-4xl mx-auto pt-20">
      ...
      <section className="text-center mb-12">
        ...
        <div className="flex justify-center space-x-6">
          <a
            href="mailto:info.bishalparajuli@gmail.com"
          ...
          <a
            href="https://github.com/BishalParajuli4"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center space-x-2 text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400"
          >
